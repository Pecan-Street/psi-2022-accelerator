...
input_variables=['astgc','omad_day','clteff_1','clteff_2','clteff_3','clteff_4','cult_nt_date','cult_b_date','feramt_n7_1','feramt_n7_2','feramt_n7_3','fert_n7_date','crop_c6_date','pltm_date','feramt_n10_1','feramt_n10_2','feramt_n10_3','feramt_n10_date','rmvstr','remwsd','harv_g_date']
...
print("check tensor sizes for APE/MSE/RMSE Calcs",dayCENT_inputs.size,dayCENT_outputs.size,dayCENT_inputs_test.size,dayCENT_outputs_test.size )
...
for epoch in range(epochrange):
    ...
    for x_batch,y_batch in train_loader:
        ...
        batch_count += 1
        if batch_count == ((x_tensor.size(dim=0)/batch)+1):  # only give the loss at the last batch, decimating loss.
            print("Batch = ",batch_count,"Epoch = ",epoch_count,"Loss = ", loss)
            losses.append(loss)
